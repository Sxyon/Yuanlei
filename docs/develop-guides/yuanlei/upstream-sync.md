...
报告必须包含：上游与元垒各自的领先/落后 commit、两侧文件清单、共同修改文件、上游触碰的 yuanlei 耦合文件、决策记录变化、README 镜像与基线一致性。差异事实由 Git 生成，不手工维护第二份清单。
...
- 同步更新 [features/README.md](features/README.md) 中受影响条目和合并注意项。
