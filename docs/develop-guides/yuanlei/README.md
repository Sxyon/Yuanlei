...
- 上游文件保持最小 diff。只在功能必需处修改上游文件，不顺手重构、格式化或重命名；新能力优先落在独立的元垒文件。
...
- 改变上游已有行为或与上游可能冲突前，先查 [decisions/](decisions/README.md)；没有记录时在同一个变更中新增元垒决策，写明上游现状、元垒改法和合并注意项。
...
- [features/README.md](features/README.md)：元垒差异化功能索引，说明功能动因、语义 Owner、关联决策和合并注意项。
