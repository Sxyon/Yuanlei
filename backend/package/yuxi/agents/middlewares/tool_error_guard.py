...
from yuxi.agents.middlewares.git_tool_error import GIT_RUNTIME_TOOL_NAMES
...
class ToolErrorGuardMiddleware(AgentMiddleware):
    ...
    def wrap_tool_call(
        ...
        try:
            ...
            if (request.tool_call or {}).get("name") in GIT_RUNTIME_TOOL_NAMES:
                raise
