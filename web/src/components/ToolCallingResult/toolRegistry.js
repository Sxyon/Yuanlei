...
export const TOOL_ICON_MAP = {
  ...
  cmd: SquareTerminal,
  coding_session_await: RefreshCw,
  coding_session_control: SquareTerminal,
  coding_session_list: Bot,
  coding_session_send: SquareTerminal,
  coding_session_start: SquareTerminal,
  coding_session_status: RefreshCw,
  edit_file: FilePen,
...
export const TOOL_NAME_MAP = {
  ...
  coding_session_control: '控制编码会话',
  coding_session_list: '编码会话列表',
  coding_session_send: '编码会话下一轮',
  coding_session_start: '启动编码会话',
